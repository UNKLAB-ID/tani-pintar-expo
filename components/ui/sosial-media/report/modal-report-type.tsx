...
const ModalReportType: React.FC<ModalReportTypeProps> = ({ modalReportType, setModalReportType, setModalReportProfie, textModalReportType, setModalReportConten, setDataModalReportConten, setModalContenHeader }) => {
    const data = [
        {
            id: 1,
