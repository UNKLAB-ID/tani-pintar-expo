...
const ModalAgreeReportSosialMedia: React.FC<ModalAgreeReportSosialMediaProps> = ({ modalAgreeReportSosialMedia, dataAgreeList, setModalAgreeReportSosialMedia, setModalReportTypeContentSosialMedia, setModalReportDetail, setReportDetailType, serReportDetailBackType, setReportDetailTypeContent }) => {
    return (
        <Modal
            ...
            >
                ...
                >
                    ...
                    <View style={{ paddingHorizontal: 16 }}>
                        <Text style={{ marginTop: 20, marginBottom: 10, fontSize: 16, fontWeight: 600, textAlign: "center" }}>{dataAgreeList.textHeader}</Text>
                        {
                            dataAgreeList.data.map((item: any, index: number) => {
                                return (
                                    <TouchableOpacity style={{ paddingVertical: 10 }} key={index} onPress={() => {
                                        ...
                                        setReportDetailTypeContent({
                                            ...
                                            textContent: "Distribution of nude images without permission"
                                        })
                                    }}>
                                        <Text>{item.text}</Text>
                                    </TouchableOpacity>
