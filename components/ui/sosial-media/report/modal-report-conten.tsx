...
const ModalReportConten: React.FC<ModalReportContenProps> = ({ data, textHeader, modalReportConten, setModalReportConten, setModalReportType, setModalReportVerify }) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
            ...
            <View style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                ...
                >
                    ...
                    <View style={{ paddingHorizontal: 16, paddingVertical: 20 }}>
                        <Text style={{ fontSize: 16, fontWeight: "600" }}>{textHeader}</Text>
                        <Text style={{ marginVertical: 12 }}>{`We don’t allow the following:`}</Text>
                        {data.map((item) => (
                            <View
                                key={item.id}
                                style={{
