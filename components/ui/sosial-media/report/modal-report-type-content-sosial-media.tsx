            ...
            >
                ...
                >
                    ...
                    <View style={{ paddingHorizontal: 16 }}>
                        <Text style={{ fontSize: 16, fontWeight: 600, textAlign: "center", marginTop: 20, marginBottom: 10 }}>{dataReportTypeContentSosialMedia.textHeader}</Text>
                        {
                            dataReportTypeContentSosialMedia.data.map((item: any, index: number) => {
                                return (
                                    <TouchableOpacity
                                        key={index}
