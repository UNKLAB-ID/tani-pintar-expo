...
const ModalReportSuccess: React.FC<ModalReportSuccessProps> = ({
  modalReportSuccess,
  setModalReportSuccess,
}) => {
  return (
    <Modal
      animationType="slide"
      ...
      <View style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
        ...
        >
            ...
            <View style={{ flex: 1 }}>
              <View style={{ marginBottom: 24 }}>
                ...
                <Text style={{ fontSize: 14, color: '#333' }}>
                  We work as quickly as possible to remove content that doesn’t
                  meet our standards, using technology and review teams.
                </Text>
              </View>
              ...
              <View>
                ...
                <Text style={{ fontSize: 14, color: '#333' }}>
                  We’ll notify you as soon as there’s an update on your Support
                  Request.
                </Text>
              </View>
            </View>
          ...
          <View style={{ paddingVertical: 20 }}>
            ...
            <ButtonReport title="Block Natasya Julio" disable={true} />
            <ButtonReport title="Restrict Natasya Julio" disable={true} />
          </View>
          <View
            style={{
              position: 'absolute',
