...
const ModalAudiencePost: React.FC<ModalAudiencePostProps> = ({ modalAudience, setModalAudience, setTextAudience, textAudience }) => {
    const data = [
        {
            option: "Public",
            ...
            <View style={{ backgroundColor: 'rgba(0,0,0,0.5)', }}>
                ...
                >
                    ...
                    <View className="flex-row items-center">
                        ...
                        <Text className="font-semibold ml-2" style={{ fontSize: 16 }}>Audience</Text>
                    </View>
                    <View className="pt-4">
                        <Text style={{ color: "#6F6F6F", fontSize: 14 }} className="font-semibold mb-1">who can see your post?</Text>
                        <Text style={{ color: "#6F6F6F", fontSize: 12 }}>Set your privacy and decide who can see your posts! You can choose a specific audience, from friends, the public, or even just certain people. Your posts also have the chance to appear on Home, Profile, search results, and Messenger</Text>
                    </View>
                    <Text style={{ color: "#6F6F6F", fontSize: 14 }} className="font-semibold mt-3">Choose Audience</Text>
                    <View>
                        {data.map((option) => (
                            <TouchableOpacity
                                key={option.option}
                            ...
                            >
                                ...
                                <View className="ml-2">
                                    <Text style={{ fontSize: 14, fontWeight: 600, color: "#6F6F6F" }}>{option.option}</Text>
                                    <Text style={{ fontSize: 12, color: "#6F6F6F" }}>{option.label}</Text>
                                </View>
                            </TouchableOpacity>
                        ))}
                    </View>
