...
const ModalShare: React.FC<ModalSHareProfileProps> = ({ modalShare, setModalShare }) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
        ...
        >
            ...
            <View style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                ...
                >
                    ...
                    <Text style={{ fontSize: 18, fontWeight: 600, marginBottom: 20 }}>Share link</Text>
                    <View style={{ backgroundColor: "#F9F9F9", height: 64, borderRadius: 12 }} className="flex-row items-center justify-between px-4">
                        <Text style={{ fontSize: 16, color: '#525252' }}>https://www.taniverse.id/natasyajulio</Text>
                    ...
                    <View className="mt-5 flex-row items-center justify-between">
                        <View >
                            <View className="flex-row items-center justify-center">
                                <View className="flex-row items-center justify-center" style={{ width: 40, height: 40, backgroundColor: "#F4F4F4", borderRadius: 999, }}>
