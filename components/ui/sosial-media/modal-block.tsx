          ...
          <View>
            <View style={{ alignItems: 'center', marginBottom: 10 }}>
              ...
              <Text className="text-center text-[14px] text-text-secondary">
                This action will block this account and prevent the creation of
                new accounts to maintain a safe environment
              </Text>
            </View>
            <View>
              <View className="flex-row items-center">
                <MessageBlockIcons width={24} height={24} />
                <Text className="text-[12px] ml-3 text-[#191919]">
                  They will no longer have access to your profile or content on
                  TaniVerse, and they won&apos;t be able to message you.
                </Text>
              </View>
              <View
              ...
              >
                ...
                <Text className="text-[12px] ml-3 text-[#191919]">
                  They don’t get a notification of the blocked.
                </Text>
              </View>
              <View className="flex-row items-center">
                <SettingIcons width={24} height={24} />
                <Text className="text-[12px] ml-3 text-[#191919]">
                  You can easily unblock a user through Settings.
                </Text>
              </View>
            </View>
            <View className="mt-5" style={{ paddingBottom: 50 }}>
              <CustomButton
                title="Block"
                className="py-[10px]"
                onPress={() => {
