                        ...
                        <View key={index} style={{ marginVertical: 3 }} className="bg-white px-5 py-4">
                            {
                                value.hidenPost ? (
                                    ...
                                    <View>
                                        ...
                                        <View className="flex-row items-center justify-between mb-2">
                                            <View className="flex-row items-center">
                                                ...
                                                <View className="ml-3 flex-row items-center">
                                                    ...
                                                    >
                                                        {value.user.profile.full_name.length > 170 ? `${value.user.profile.full_name.slice(0, 170)}...` : value.user.profile.full_name}
                                                    </Text>
                                        ...
                                        {/* Caption */}
                                        <View className="mb-2">
                                            <Text className="text-[#1F1F1F] text-[14px]">{value.content}</Text>
                                        </View>
                                        ...
                                        <View className="flex-row items-center">
                                            <View className="flex-row items-center justify-between" style={{ width: 49 }}>
                                                ...
                                                <Text className="text-[14px] text-[#434343] ml-2">{value.likes_count === 0 ? `${value.likes_count}` : `${value.likes_count}K`}</Text>
                                            </View>
                                            <TouchableOpacity
                                            ...
                                            >
                                                ...
                                                <Text className="text-[14px] text-[#434343] ml-2">{value.comments_count === 0 ? `${value.comments_count}` : `${value.comments_count}K`}</Text>
                                            </TouchableOpacity>
                                            <View className="flex-row items-center justify-between" style={{ width: 49 }}>
                                                <TouchableOpacity>
                                                    <ShereIcons width={18} height={18} color={"#434343"} />
                                                </TouchableOpacity>
                                                <Text className="text-[14px] text-[#434343] ml-2">{value.shared_count === 0 ? `${value.shared_count}` : `${value.shared_count}K`}</Text>
                                            </View>
                                        </View>
                                    </View>
                                )
