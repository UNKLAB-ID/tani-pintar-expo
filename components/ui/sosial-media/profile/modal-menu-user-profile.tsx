...
const ModalUserMenuProfile: React.FC<ModalUserMenuProfileProps> = ({ modalUserMenu, setModalUserMenu, setModalBlock, setModalReport, setModalShare, setModalCopyLink, setModalAboutThisProfile }) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
