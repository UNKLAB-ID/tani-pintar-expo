...
const ModalReportProfileUser: React.FC<ModalAboutProfileUserProps> = ({ modalProfileUser, setModalProfileUser, setModalReport, setModalReportType, setTextModalReportType }) => {
    const data = [
        {
            id: 1,
            text: "Fake identity"
            ...
            <View style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                ...
                >
                    ...
                    <View className="flex-row items-center justify-between" style={{ borderBottomWidth: 1, borderBottomColor: "#E9E9E9", paddingHorizontal: 16, paddingBottom: 10 }}>
                        <TouchableOpacity className="flex-row items-center justify-center" style={{ width: 25 }} onPress={() => {
                            setModalProfileUser(false)
                            setModalReport(true)
                        }}>
                        ...
                        <View className="flex-row items-center justify-center" style={{ width: 25 }} >

                        </View>
                    </View>
                    <View style={{ paddingHorizontal: 16 }}>
                        <View style={{ paddingTop: 20, }}>
                            <Text className="font-semibold">What is your reason for wanting to report this profile?</Text>
                            <Text style={{ color: "#AAAAAA", marginVertical: 10 }}>Please select the reason that best fits your report.</Text>
                        </View>
                        {
                            data.map((item, index) => {
                                return (
                                    <TouchableOpacity
                                        key={index}
                                        style={{ paddingVertical: 20, borderBottomWidth: 1, borderBottomColor: "#E9E9E9" }}
                                        onPress={() => {
