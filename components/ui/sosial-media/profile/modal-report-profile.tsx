...
const ModalReportProfile: React.FC<ModalReportProfileProps> = ({ modalReport, setModalReportProfile, setModalReport, setModalReportPost }) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
            ...
            <View style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                ...
                >
                    ...
                    <View style={{ paddingHorizontal: 16 }}>
                        ...
                        >
                            <Text className="font-semibold" style={{ fontSize: 14 }}>What is your reason for reporting this profile?</Text>
                            <Text style={{ color: "#AAAAAA", paddingVertical: 10 }}>Your report will remain anonymous, except in cases of intellectual property rights violations. In case of emergency, contact your local emergency services immediately for assistance.</Text>
                            <TouchableOpacity
                                onPress={() => {
                                    setModalReport(false)
