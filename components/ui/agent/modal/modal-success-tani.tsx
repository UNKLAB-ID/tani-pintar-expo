...
const ModalSuccessTani: React.FC<ModalSuccessTaniProps> = ({ modalSuccess, setModalSuccess }) => {
                ...
                >
                    ...
                    <View style={{ paddingHorizontal: 16 }}>
                        <Text style={{
                            ...
                            fontSize: 18,
                            textAlign: "center"
                        }}>Penawaranmu berhasil diajukan.</Text>
                        <Text style={{
                            fontWeight: 600,
                            fontSize: 18,
                            textAlign: "center"
                        }}>diajukan.</Text>
                        <Text style={{ textAlign: "center", marginTop: 10, marginBottom: 50 }}>Kamu bisa cek statusnya kapan saja di menu penawaran</Text>
                    </View>
