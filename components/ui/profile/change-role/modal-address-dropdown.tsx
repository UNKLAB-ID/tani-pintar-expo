...
const ModalAddressDropdown: React.FC<ModalAddressDropdownProps> = ({
  modalAddress,
  setModalAddress,
}) => {
  ...
  const hasValue =
    vendorData.province_name || vendorData.city || vendorData.district_name;
      ...
      >
        ...
        >
          ...
          <View className="flex-row items-center justify-between mb-4">
            ...
            <Text className="text-center font-semibold text-[18px]">
            ...
            <TouchableOpacity
              ...
              style={{ paddingVertical: 8 }}
            >
              <Text style={{ color: hasValue ? 'red' : '#8D8D8D' }}>Reset</Text>
            </TouchableOpacity>
          </View>
          <View
            style={{
                ...
                >
                  {item === 'kota' ? (
                    <Text
                      ...
                      style={{
                        color: typeAddress === item ? '#169953' : 'black',
                      }}
                    >
