...
const AiScreen = () => {
  ...
  useEffect(() => {
    router.replace("/thinkflow/plant-disease-analyzer");
  }, []);
      ...
      <View className="bg-white rounded-2xl p-5 shadow-md">
        ...
        {textInput.length > 0 && (
          <View className="bg-gray-100 p-4 mt-5 rounded-xl shadow-sm">
            <Text className="text-gray-700 text-lg font-semibold">Result:</Text>
            <Text className="text-gray-600 text-base">{textInput}</Text>
          </View>
        )}
      </View>
    </ScrollView>
