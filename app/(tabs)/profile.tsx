  ...
  return (
    <ScrollView className="flex-1 bg-gray-100">
      ...
      <View className="items-center -mt-12">
        ...
        <Text className="text-gray-600">150 Followers • 50 Following</Text>
      ...
      <View className="px-4 py-3 bg-white mt-3 rounded-lg shadow-md">
        ...
        <Text className="text-gray-600 mt-1">
          Saya adalah petani yang sudah berkecimpung selama 11 tahun dan saya
          senang dengan pekerjaan ini. Semoga pertanian di Indonesia semakin
          maju dan berkembang! 🚜
        </Text>
      </View>
      ...
      <View className="flex-row justify-between px-4 mt-5">
        ...
        >
          <Text className="text-white font-semibold">Write a post</Text>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity className="bg-white py-3 mt-3 mx-4 rounded-lg shadow-md items-center">
        <Text className="text-green-600 font-semibold">View All Posts</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
