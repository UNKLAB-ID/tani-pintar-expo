...
import { SafeAreaView, Text, View, TouchableOpacity, StatusBar, KeyboardAvoidingView, Platform, ScrollView } from "react-native"
            ...
            >
                ...
                >
                    ...
                    <View style={{ marginBottom: 20, marginTop: 15 }}>
                        <Text style={{ fontWeight: '600', fontSize: 18, color: "#000" }}>Information</Text>
                        <Text style={{ fontWeight: '400', fontSize: 12, color: "#AAAAAA" }}>Required Fields*</Text>
                    </View>
                    ...
                    {/* Community */}
                    <Text style={{ fontWeight: '600', fontSize: 18, color: "#000", marginBottom: 20, marginTop: 10 }}>Community</Text>
                    <View className="mb-4">
                        <Controller
                            control={control}
                    ...
                    <View className="mb-4">
                        ...
                        >
                            <Text style={{ fontSize: 16, color: selectedCountry ? '#000' : '#AAA' }}>
