  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff", paddingTop: insets.top, paddingBottom: insets.bottom, }}>
      ...
      <View style={styles.header}>
        ...
        <Text style={{ fontSize: 16, fontWeight: "600", marginLeft: 10 }}>Pin Alamat</Text>
      ...
      <View style={{
        ...
        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
          ...
          <Text style={{ fontSize: 16, fontWeight: "600" }}> Lokasi Dipilih</Text>
        </View>
        <Text>{address}</Text>
        <Text>
        ...
        <TouchableOpacity style={styles.confirmButton} onPress={handleConfirm}>
          <Text style={{ color: "#fff", fontWeight: "600" }}>Konfirmasi Lokasi</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
