    ...
    <ScrollView className="flex-1 bg-green-50 p-4">
      <View className="items-center mt-10 mb-8">
        ...
        <Text className="text-base text-gray-600 mb-4 text-center">
          Berikut hasil analisa gambar tanaman yang Anda upload.
        </Text>
        {imageUri && (
          <Image
        ...
        <View className="bg-white rounded-xl shadow-md p-5 w-full max-w-xl">
          ...
          <Text className="text-gray-700 text-base mb-2">
            ...
            Tanaman terdeteksi terkena penyakit{' '}
            <Text className="font-bold text-red-600">Hawar Daun</Text>.
          </Text>
          {userText && (
            <Text className="text-gray-500 text-sm mt-2">
              Catatan Anda: {userText}
            </Text>
          )}
        </View>
      </View>
