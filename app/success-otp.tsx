...
const SuccessOTPScreen = () => {
  return (
    <SafeAreaView className="flex-1 bg-white px-5 pt-[64px]">
      ...
      <View>
        <Text className="text-[24px] font-bold text-center text-text-primary mt-[50px]">
          Account Created Successfully!
        </Text>
        <Text className="text-[16px] text-center text-text-secondary mt-3">
          Your account has been successfully created. Now, you can start
          exploring all the available features.
        </Text>
      </View>
